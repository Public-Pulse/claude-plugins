...
After documentation is written, suggest: "Consider running `/compound-rules <solution-doc-path>` to promote this learning to a permanent AI rule."

## Routes To

`compound-docs` skill, `compound-rules` skill (suggested)
