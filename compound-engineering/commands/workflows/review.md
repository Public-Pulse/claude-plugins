...
**When to run:**
- PR includes files matching `supabase/migrations/*.sql`
- PR modifies columns that store IDs, enums, or mappings
- PR includes data backfill scripts or backfill scripts in `scripts/`
...
**Tagging:** Always add `code-review` tag, plus: `security`, `performance`, `architecture`, `react`, `supabase`, `tanstack-query`, `quality`, etc.
